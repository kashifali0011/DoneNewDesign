...
import com.dtech.done.doneapp.utilities.utils.RealPathUtil
...
fun Activity.onTokenExpiredLogout() {
    ...
    val token = DoneApp.db.getString(Constants.DEVICE_ID)
    val toTour = DoneApp.db.getBoolean(Constants.CONST_IS_TOUR)
    val userPhone = DoneApp.db.getString(Constants.CONST_USER_PHONE)
    DoneApp.db.clear()
    DoneApp.db.putString(Constants.DEVICE_ID, token!!)
    DoneApp.db.putString(Constants.CONST_USER_PHONE , userPhone!!)
    DoneApp.db.putBoolean(Constants.CONST_IS_LOGIN, false)
    DoneApp.db.putBoolean(Constants.CONST_IS_TOUR, toTour)
