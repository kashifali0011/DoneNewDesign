package com.dtech.done.doneapp.view.base
...
open class BaseFragment : Fragment() {
    ...
    fun ClearAllFragments() {
        for (loop in 0 until requireActivity().supportFragmentManager.backStackEntryCount) {
    ...
    override fun onDestroyView() {
        ...
        when (ActivityBase.activity) {
            is MainActivity -> {
                (ActivityBase.activity as MainActivity).checkVisibleFragment()
            }
        }
    }

    open fun beforeTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
    open fun onTextChanged(p0: CharSequence?, p1: Int, p2: Int, p3: Int) {}
    open fun afterTextChanged(p0: Editable?) {}
