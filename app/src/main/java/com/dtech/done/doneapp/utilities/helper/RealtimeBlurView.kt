...
class RealtimeBlurView(context: Context, attrs: AttributeSet) : View(context, attrs) {
    ...
    init {
        ...
        mBlurRadius = a.getDimension(R.styleable.RealtimeBlurView_realtimeBlurRadius, TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 10f, context.resources.displayMetrics))
        ...
        if (mDirty || mRenderScript == null) {
            if (mRenderScript == null) {
                try {
                    ...
                    if (isDebug(context)) {
                        if (STOP_EXCEPTION.message != null && STOP_EXCEPTION.message.startsWith("Error loading RS jni library: java.lang.UnsatisfiedLinkError:")) {
    ...
    companion object {
        ...
        init {
            try {
                RealtimeBlurView::class.java.classLoader!!.loadClass("android.renderscript.RenderScript")
        ...
        internal var DEBUG: Boolean? = null
